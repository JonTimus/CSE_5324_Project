...
<body onload="">
	...
	<nav class="navbar navbar-expand-lg navbar-light bg-dark fixed-top">
		<a class="navbar-brand text-white" href="../admin_main.php">Jobify</a>
						...
						<div class="row">
							...
							?>
								...
								<div class="card ml-5 mt-4" style="width: 18rem;">
									<img class="card-img-top" height='250px' src="../../uploads/thumbnail/<?php echo $course_list['language_image'] ?>" alt="Card image cap">
									<div class="card-body">
										<h5 class="card-title"><?php echo $course_list['language_name']; ?> <a href="edit_topics.php?course_name=<?php echo $course_list['language_name']; ?>" class="h6 text-info float-right">Edit Info <i class="fa fa-pencil ml-1"></i></a></h5>
