         ...
         <ul class="list-group text-white sidebar-list">
			...
			<div class="col-md-10 ">
				...
				<ul class="nav nav-tabs">
					...
					<li class="nav-item">
						<a class="nav-link" data-toggle="tab" href="#manage_course">Manage Video Course</a>
					</li>
					<!--  <li class="nav-item">
    <a class="nav-link" data-toggle="tab" href="#menu2">Menu 2</a>
				...
				<div class="tab-content">
					...
					<div class="tab-pane container active" id="home">
						<div class="card-header mt-3 mr-5 bg-dark text-info border-3 shadow card1" style="width: 1050px; box-shadow: 1px 1px 1px 1px #ccc"><b>All videos</b></div><br>
						<div class="row">
