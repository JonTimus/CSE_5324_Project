...
<body>
    ...
    <div class="container text-light">
        <h1 class="text-center my-5 fw-bold"><?php echo $_SESSION['username']; ?>'s Resume Form</h1>
        <div class="form-container">
            <form action="submit.php" target="_blank" method="POST" enctype="multipart/form-data">
                ...
                <div class="border border-dark p-3 mb-3">
                    ...
                    <div class="d-flex justify-content-between mb-3">
                        <div>
                            ...
                            <input type="text" name="first_name" class="form-control" placeholder='<?php echo $_SESSION['username']; ?>' required>
                        </div>
                        <div>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="tel" class="form-control" id="phone" name="phone" placeholder="214-123-4567" pattern="[0-9]{3}-[0-9]{3}-[0-9]{4}" required>
                    </div>
                </div>
                <div class="border border-dark p-3 mb-3">
                    <h2>Skills (Max:5)</h2>
