...
<body>
		...
		<div class="row" >
			...
			<div class="card" >
				<div class=" card-header card-primary p-1">
					<h2 class="text-success text-center">WELCOME TO JOBIFY PLATFORM</h2>

				</div>
				<div class="card-body p-1">
					<h4 class="text-secondary text-center">Try solving quizzes</h4>
				</div>
			</div>
		</div>
		</div>
	...
	<div class="container">
		<div class="row">
			...
			<div class="col-sm-6">
				<div class="card" style="box-shadow: 2px 2px 2px 2px #dfdfdf;">
				  <div class="card-header bg-primary text-light p-2 "><h3>Login</h3></div>
				   <?php 
		...
		<div class="col-sm-6">
				<div class="card" style="box-shadow: 2px 2px 2px 2px #dfdfdf;">
				  <div class="card-header bg-primary text-light p-2"><h3>Sign Up</h3></div>
				  <?php 
