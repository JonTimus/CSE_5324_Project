...
<center style="height: 50px; background-color: #aeaeaee0; "><p class="text-white h3" style="" > Watch <?php echo $_GET['course_name']; ?> Online videos</p></center><br><br>
		...
		$course_name=$_GET['course_name'];
			...
			while ($row=mysqli_fetch_array($query))
		 {
		 	...
		 	<div class="inner">                                                  <!--  to zoom in and zoom out effect -->
				<img class="card-img-top " style="height: 11rem;" src=../../uploads/thumbnail/<?php echo $row['video_image']; ?> alt="Card Image">
			</div>
